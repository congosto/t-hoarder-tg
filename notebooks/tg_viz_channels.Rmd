...
if(ARS == TRUE) {
  ...
  msgs <- read_csv(
    ...
    cols_only( 
      ...
      from_channel_name = col_character(),
...
-   Establecer pico máximo par limite eje Y
...
p <- msgs_vs_views(msgs_df, "total",  min_date, max_date, params$min_suscribers, params$max_overlaps ) 
print(p)
...
if(params$zoom) {
  ...
  p <- msgs_vs_views(msgs_df, "zoom", params$date_ini_zoom, params$date_end_zoom, params$min_suscribers_zoom, params$max_overlaps)
  print(p)
  # Grabar la gráfica en un archivo
...
p <- msgs_vs_forward_out(msgs_df , "total",  min_date, max_date) 
print(p)
# Grabar la gráfica en un archivo
...
```{r msgs_vs_forward_total, echo=FALSE, fig.height=5, fig.width=9, message=FALSE, warning=FALSE, paged.print=FALSE}
# Llamamos a la función msgs_vs_forward
p <- msgs_vs_forward_in(msgs_df , "total",  min_date, max_date) 
print(p)
# Grabar la gráfica en un archivo
ggsave(paste0(img_path,base_name_file_img,"_msgs_vs_forward_total.png"))
...
if(params$zoom) {
  # Llamamos a la función msgs_vs_forward
  p <- msgs_vs_forward_in(msgs_df , "zoom",  params$date_ini_zoom, params$date_end_zoom) 
  print(p)
  # Salvamos la gráfica en un archivo
  ggsave(paste0(img_path,base_name_file_img,"_msgs_vs_forward_zoom.png"))
}
