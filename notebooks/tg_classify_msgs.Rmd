...
params:
    ...
    dataset_name : "alvise_n2"            # Nombre del dataset
    msgs : "msgs_dataset.csv"            # Nombre del dataset
    file_gephi: "alvise_n2_nodos.csv"            # Nombre del fichero que se ha exportado de gephi
    max_communities: 2                    # El valor máximo es 14 pero se puede poner un número menor
---
...
Este script clasifica los msgs según la "modularity class" calculada
